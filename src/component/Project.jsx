      ...
      <section className="sec-02 py-5" id="projects">
        <div className="container">
          <div>
            ...
            <h5 className="mb-5">
              Engineering solutions that make a real-world difference.
            </h5>
          </div>
              ...
              <div className="card h-100 card-custom">
                ...
                <div className="card-body d-flex flex-column">
                  ...
                  <p className="card-text">
                    A full-featured E-commerce web application built to enables
                    users to browse products, manage their carts and wishlists
                    user manage products, categories, orders, and users through
            ...
            <div className="col">
              <div className="card h-100 card-custom">
                ...
                <div className="card-body d-flex flex-column">
                  ...
                  <p className="card-text">
                    A full-stack event web app built with the MERN stack
                    (MongoDB, Express.js, React, Node.js). Users can browse
                    upcoming events on the landing page, search by title, filter
                    by online/offline, and view detailed event.
                  </p>
                  <div className="mb-3">
                    <span className="badge bg-secondary me-1">MongoDB</span>
                    <span className="badge bg-secondary me-1">Express</span>
            ...
            <div className="col">
              <div className="card h-100 shadow-sm card-custom">
                ...
                <div className="card-body d-flex flex-column">
                  ...
                  <p className="card-text">
                    The Anvaya CRM app will focus on lead management with
                    defined steps for each lead's lifecycle. We will assign
                    sales agents to leads and allow users to add comments or
                    updates to each lead.
                  </p>
                  <div className="mb-3">
                    <span className="badge bg-secondary me-1">MongoDB</span>
                    <span className="badge bg-secondary me-1">Express</span>
